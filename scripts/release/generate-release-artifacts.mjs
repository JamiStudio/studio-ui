...
function generateReleaseNotes() {
  ...
  const lines = [
    ...
    "",
    "Public npm packages, the hosted registry/docs routes, and the v0.1.0 GitHub Release artifacts are published. These generated notes still do not claim hosted workbench/showcase routes, hosted suite routes, hosted persistence, backend registration, final brand canon, harness runtime behavior, or complete final acceptance.",
    "",
    "## Summary",
    "",
  ...
  lines.push(
    "## Not Yet Claimed",
    "",
    "- No hosted workbench/showcase route at `registry.jami.studio/`.",
