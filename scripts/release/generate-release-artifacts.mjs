...
function generateSbom() {
  ...
  const bom = {
    ...
    properties: [
      ...
      { name: "studio-ui:hosted-registry-claimed", value: "registry-docs-custom-domain-live" },
      { name: "studio-ui:custom-registry-domain-claimed", value: "true" },
      { name: "studio-ui:hosted-workbench-claimed", value: "false" },
      { name: "studio-ui:hosted-suite-routes-claimed", value: "false" },
      { name: "studio-ui:npm-package-publish-claimed", value: "true" },
      { name: "studio-ui:npm-provenance-metadata-claimed", value: "true" },
      { name: "studio-ui:release-attestation-executed", value: "github-release-assets-and-npm-provenance-metadata-only" },
...
function generateReleaseNotes() {
  ...
  const lines = [
    ...
    "",
    "Status: Generated from `.changes/` fragments for public 0.1.0 release",
    "Source: `.changes/*.md`",
    ...
    "",
    "Public npm packages, the hosted registry/docs routes, hosted static workbench/suite preview routes, and the v0.1.0 GitHub Release artifacts are published. These generated notes still do not claim hosted persistence, backend registration, hosted suite runtime, final brand canon, harness runtime behavior, or complete final acceptance.",
    "",
    "## Summary",
    "",
  ...
  lines.push(
    "## Not Yet Claimed",
    "",
    "- The hosted workbench/showcase route at `registry.jami.studio/` is a static preview route, not a persisted hosted workbench backend.",
    "- No hosted suite route deployment.",
    "- No hosted package-registration backend or persisted workbench save/register route.",
    "- No release-attached SBOM verification in this repo beyond generated SBOM checks, GitHub release assets, and npm provenance metadata.",
